...
<label class='col-sm-3 col-form-label' for='passwordqn'>Password Recovery Question :</label>
<div class='col-sm-9'>
...
$MainContent .= "<div class='form-group row'>";       
$MainContent .= "<div class='col-sm-9 offset-sm-3'>";
$MainContent .= "<button type='submit' class='btn btn-primary'>Register</button>";
$MainContent .= "</div>";
$MainContent .= "</div>";
$MainContent .= "</form>";
$MainContent .= "</div>";
